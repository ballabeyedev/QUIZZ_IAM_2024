...
if (isset($_POST['Email']) && isset($_POST["passwd"])) {
    ...
    if ($user) {
        if ($user['role'] === "joueur" && $user['statut'] === "bloque") {
            die("Votre compte est bloqué. Veuillez contacter l'administrateur pour plus d'informations.");
        }
...
<head>
    ...
    <title>Page Connexion | Quizz</title>
</head>
<body>
