<?php
    ...
    try {
        ...
        die("Erreur, basse de donnee: " . $e->getMessage());
    }
    ...
    $stmtQuestions->execute(['theme' => 'manga']);
...
<head>
    ...
    <style>
        ...
        form { max-width: 600px; margin-top: -500px; background-color: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); margin-left: 150px; }
        ...
        .soum { background-color:rgb(139, 0, 139); color: #fff; padding: 10px 15px; border: none; border-radius: 4px; cursor: pointer; font-size: 16px; }        
        button:hover { background-color: #45a049; }        button:hover { background-color: #45a049; }
...
<body>
    ...
    <div class="text">
        <h3>VOUS AVEEZ CHOISIE L'OPTION: <span>MANGA</span></h3>
    </div>
    <div class="div">
        <form action='Manga.php' method='post'>
            <a href="javascript:history.go(-1)">RETOUR</a>
            <p>Veillez repondre a ces question <br> Bonne chance</p>
            ...
            <?php
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    echo "<p><a href='reponse3.php'>Je veux voir mes reponses correcte et incorrecte !</a>";
                }
            ?>
        </div>
        </form>
