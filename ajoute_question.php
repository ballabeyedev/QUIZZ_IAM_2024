...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['libelle'])) {
    ...
    // Préparation de la requête d'insertion des réponses
...
<div class="tq">
<hr class="hr">
<div class="ins"><img src="image/aqu.png" alt=""></div>
...
<div class="l1"><hr class="l1"></div>

    <?php else: ?>
        <h3>AJOUTE RÉPONSES</h3>
        <form id="responseForm" class="login" method="post">
            <input type="hidden" name="id_question" value="<?php echo $id_question; ?>">
            <div>
                <label>Réponse 1:</label>
                <input type="text" name="reponses[1][text]" required>
                <select name="reponses[1][is_correct]">
            ...
            <div>
                ...
                <input type="text" name="reponses[2][text]" required>
                <select name="reponses[2][is_correct]">
                    <option value="0">Faux</option>
                    <option value="1">Vrai</option>
                </select>
            </div>
            <div>
                ...
                <input type="text" name="reponses[3][text]" required>
                <select name="reponses[3][is_correct]">
                    <option value="0">Faux</option>
                    <option value="1">Vrai</option>
                </select>
            </div>
