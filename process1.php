...
<body>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<form method='post'>
                        ...
                        <button name='btn_masquer' value=" .$row['id_question']." >Masquer</button>
                     </form>";
            }
            echo "</table>";
            if(isset($_POST)) {
                ...
                if(isset($_POST["btn_masquer"])){
                    masquerQuestion($_POST["btn_masquer"]);
                }
            }
        } else {
    ...
    ?>
        ...
        function masquerQuestion($id) {
            ...
            $sql = "UPDATE question SET statut = 'masquee' WHERE id_question = $id";
        
            if ($conn->query($sql) === TRUE) {
                echo "Question masquée avec succès.";
            } else {
                echo "Erreur lors du masquage de la question : " . $conn->error;
            }
        ...
        ?>
        <div class="l2"><img src="image/mo.jpg" alt=""></div>
