...
$stmtQuestions->execute(['theme' => 'culture']);
...
<head>
    ...
    <style>
        ...
        form { max-width: 600px; margin-top: -500px; background-color: #fff; padding: 20px; border-radius: 15px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); margin-left: 200px; }
        ...
        .profils img { height: 20px; border: 2px solid black; border-radius: 30px; margin-top: 10px; }
        .profils { margin-left: 900px; }
        .logo { display: flex; align-items: center; margin-bottom: 30px; background-color: #3498db; padding: 10px; width: 180px; height: 620px; margin-top: -50px;}
...
<body>
    ...
    <div class="text">
        <h3>VOUS AVEEZ CHOISIE L'OPTION: <span>CULTURE</span></h3>
    </div>
    <div class="div">
        <form action='culture.php' method='post'>
            <a href="javascript:history.go(-1)">RETOUR</a>

            <p>Bienvenue sur la page questionnaire <br> Veuillez repondre a ces question <br> Bonne chance</p>
